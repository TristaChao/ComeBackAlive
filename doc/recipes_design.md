...
*   **未來規劃:** 考慮引入盤子/碗的生命週期（髒盤、清洗水槽、洗碗機升級），但作為後續進階功能實作。

## 4. 系列套餐與增益效果 (Set Menus & Buffs) - 長期目標

這是一個長期的遊戲目標系統，旨在鼓勵玩家探索並製作多樣化的料理。

*   **料理標籤:** 每一道最終的料理成品，都將擁有「菜系」和「類型」兩種標籤。
    *   **菜系 (Cuisine):** 例如：`義式`、`日式`、`家常菜`...
    *   **類型 (Course):** 例如：`開胃菜`、`主餐`、`湯品`、`甜點`...
